      ...
      <section className="py-24 lg:py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl font-serif text-[#03045E] mb-6">
            {t("Libérez votre joie de vivre", "Release Your Joy of Living")}
          </h2>
          ...
          <div className="space-y-6 text-base lg:text-lg leading-relaxed text-[#023E8A] mb-12">
            <div>
              <h3 className="text-xl font-semibold text-[#03045E] mb-2">
                {t("Vous avez besoin d'un boost de vitalité ?", "Do you need a vitality boost?")}
              </h3>
              <p>
                {t(
                  "Le rire est un remède naturel pour renforcer votre énergie et retrouver une sensation de légèreté.",
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#03045E] mb-2">
                {t("Vous vous sentez stressé(e) ou tendu(e) ?", "Do you feel stressed or tense?")}
              </h3>
              <p>
                {t(
                  "Grâce au yoga du rire, apprenez à relâcher vos tensions et à vivre pleinement le moment présent.",
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#03045E] mb-2">
                {t("Vous souhaitez apporter une énergie gagnante à votre entreprise ?", "Want to bring winning energy to your company?")}
              </h3>
              <p>
                {t(
                  "Renforce la cohésion d'équipe, accroît les performances, la motivation et une meilleure communication des collaborateurs.",
            ...
            <div className="bg-[#F0F9FF] border border-[#ADE8F4] rounded-2xl p-8">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>{t("Renforcement du système immunitaire", "Strengthened immune system")}</li>
                <li>{t("Libération d'endorphines (hormones du bonheur)", "Release of endorphins (happiness hormones)")}</li>
                <li>{t("Amélioration de la qualité du sommeil", "Improved sleep quality")}</li>
                <li>{t("Cohésion d'équipe en entreprise", "Team cohesion in business")}</li>
                <li>{t("Sensation de légèreté et de bien-être", "Feeling of lightness and well-being")}</li>
              </ul>
            </div>
          </div>
